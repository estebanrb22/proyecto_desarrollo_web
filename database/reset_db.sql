...
DROP TABLE IF EXISTS `tarea2`.`pedido_verdura_fruta`;
DROP TABLE IF EXISTS `tarea2`.`pedido`;
DROP TABLE IF EXISTS `tarea2`.`producto_verdura_fruta`;
DROP TABLE IF EXISTS `tarea2`.`producto`;

...
const validateForm = () => {
    ...
    const comuna_selector = document.getElementById("comuna_selector");
    const compradorName = document.getElementById("comprador_name");
    const compradorEmail = document.getElementById("comprador_email");
